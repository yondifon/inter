...
export const MCP_INSTRUCTIONS = [
  ...
  "Reply and resume retain the original scope; broader access requires fresh approval and a fresh delegate call.",
...
export const DELEGATE_DESCRIPTION = [
  ...
  "The scope field is required and enforced relative to cwd: file paths are literal, directory/** is recursive, and ** grants the whole working tree including hidden files and .git contents.",
